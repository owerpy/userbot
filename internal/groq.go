...
- weight_kg — вес ГРУЗА В КИЛОГРАММАХ, не количество машин.
  «20 тонн» -> 20000, «5 т» -> 5000, «500 кг» -> 500.
  Реальный груз фуры — до 40000 кг. Если получается больше, значит это не вес.
- Не пиши в регион слова «водий»/«vodiy» (долина), «вилоят», «область» —
  нужен сам регион: «Farg'ona vodiysi» -> «Фергана».
- Отбрасывай узбекские падежные окончания: «Toshkentdan» -> «Ташкент»,
  «O'shga» -> «Ош», «Samarqandga» -> «Самарканд», «Xorazmda» -> «Хорезм».
- Если в посте СПИСОК из нескольких разных маршрутов (несколько строк вида
  «регион — цена»), это сводка, а не одно объявление: верни {"is_ad": false}.
- Телефон ищи внимательно: он может быть без «+998», просто «901234567»
  или в конце текста отдельной строкой. Без контакта объявление бесполезно.
